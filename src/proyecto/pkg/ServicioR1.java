 ...
 * @author libreria6
 */
public class ServicioR1 extends javax.swing.JInternalFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       ((Emergente) SwingUtilities.getWindowAncestor(this)).dispose();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if("".equals(this.jTextField1.getText())){
            ...
            try {
                ...
                Logger.getLogger(ServicioR1.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
         ((Emergente) SwingUtilities.getWindowAncestor(this)).dispose();
